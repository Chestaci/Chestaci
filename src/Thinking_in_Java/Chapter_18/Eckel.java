...
// describe inner classes:
                    ...
                    String type =
                            "Thinking_in_Java.Chapter_18." + outer.getSimpleName() + "$" + className;
...
class E11_GreenhouseControls2 {
    public static void main(String[] args) {
        GreenhouseControls2 gc =
                new GreenhouseControls2("src/Thinking_in_Java/Chapter_18/GreenhouseConfig.dat");
        try {
            if(args.length == 1)
