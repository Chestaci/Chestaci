...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    static class UpperCaseConverter implements UnaryFunction<String, Two> {
        @Override
        public String function(Two x) {
            return x.getS().toUpperCase();
        }
    }

    static class UpperCaseReverseConverter implements UnaryFunction<String, Two> {
        @Override
        public String function(Two x) {
            x.reverse();
            return x.getS().toUpperCase();
    ...
    static class Combination implements Combiner<One> {

        @Override
        public One combine(One x, One y) {
            x.setI(x.getI() + y.getI());
            return x;
        }
    }

    static class Incrementator implements UnaryFunction<One, One> {
        @Override
        public One function(One x) {
            x.increment();
            return x;
        }
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        System.out.println();
        List<One> oneList = Arrays.asList(new One(1), new One(2), new One(3));
        List<Two> twoList = Arrays.asList(new Two("one"), new Two("two"), new Two("Supercalifragilisticexpialidocious"));
        print(transform(oneList, new Incrementator()));
        System.out.println();
        print(reduce(oneList, new Combination()));
        System.out.println();
        print(transform(twoList, new UpperCaseConverter()));
        System.out.println();
        print(transform(twoList, new UpperCaseReverseConverter()));
