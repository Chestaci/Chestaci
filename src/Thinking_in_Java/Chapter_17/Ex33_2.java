...
class FastTraversalLinkedList2<T> extends AbstractList<T> {
...
class ListPerformance4 {
    ...
    static {
        ...
        tests.add(new Test2<List<Integer>>("remove_I ") {
            int test(List<Integer> list, TestParam tp) {
                int count = 0;
        ...
        tests.add(new Test2<List<Integer>>("remove_O") {
            int test(List<Integer> list, TestParam tp) {
                int count = 0;
                for(int i = list.size() / 2 ; i < list.size();
                    i++) {
    ...
    public static void main(String[] args) {
        ...
        ListTester.run(
                new FastTraversalLinkedList2<Integer>(), tests);
        ListTester.run(
